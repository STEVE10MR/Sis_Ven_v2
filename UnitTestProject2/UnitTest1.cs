...
namespace UnitTestProject2
{
    ...
    public class UnitTest1
    {
        ...
        public void RegistroDetallePedido()
        {
            ...
            bool x = user.RegistrarDetallePedido(new DetallePedido() { Pedido = new Pedido() { ID_Pedido = 30 }, Material = new Material() { ID_Material = 5 }, Cantidad = 1, PrecioUnit = 1, SubTotal = 1 });
